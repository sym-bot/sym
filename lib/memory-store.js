...
class MemoryStore {
   ...
   * @param {object} entry
   * @param {object} opts
   * @param {string} opts.creatorRole — lifecycle role of the creating node (observer/validator/anchor)
  ...
  receiveFromPeer(peerId, entry, opts = {}) {
    ...
    const creatorRole = opts.creatorRole || 'observer';
   ...
   * equal. Apps that benefit from the split (e.g. retain own
   * lineage 90d, peer chatter 30d) configure via
