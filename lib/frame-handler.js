...
const { encode, DIM, processHeuristicSVAF, computeFieldVerdicts, decryptFields, blockKeyV2, resolveTetherAnchor, signTetherAttestation, verifyTetherAttestation, recomputeKey, classifyAddress } = require('@sym-bot/core');
