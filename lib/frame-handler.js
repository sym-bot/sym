...
const { encode, DIM, processHeuristicSVAF, computeFieldVerdicts, decryptFields, mintRemixKey, resolveTetherAnchor, signTetherAttestation, verifyTetherAttestation } = require('@sym-bot/core');
