...
const { encode, DIM, processHeuristicSVAF, computeCategoryVerdicts, decryptCategories, blockKeyV2, resolveTetherAnchor, signTetherAttestation, verifyTetherAttestation, recomputeKey, classifyAddress } = require('./core');
