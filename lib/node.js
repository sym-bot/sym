...
class SymNode extends EventEmitter {
  ...
  constructor(opts = {}) {
    ...
    // Frame handler — relayMode skips SVAF (Section 16.1)
    this._relayMode = opts.relayMode || false;
    this._frameHandler = new FrameHandler(this, { relayMode: this._relayMode });
...
Object.defineProperty(module.exports, 'claude', {
  get() { return require('./claude-reason'); },
  enumerable: true,
});

// Removed in 0.4.0 — agents import { claude } now, not { claudeReason }
Object.defineProperty(module.exports, 'claudeReason', {
  get() { throw new Error('claudeReason was removed in 0.4.0. Use: const { claude } = require("@sym-bot/sym"); claude.invoke({...})'); },
  enumerable: false,
});
